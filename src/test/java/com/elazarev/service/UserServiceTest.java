...
//        when(userRepository.findByLogin("AnyName")).thenReturn(user);
//
//        assertThat(user, is(userService.findByLogin("AnyName")));
//        assertNull(userService.findByLogin("SomeOther"));
//
//        verify(userRepository).findByLogin("AnyName");
//        verify(userRepository).findByLogin("SomeOther");
//
//    }
//
//    @Test
...
//
//        assertEquals(userService.getPage(1), pageOne);
//        assertEquals(userService.getPage(2), pageTwo);
//
